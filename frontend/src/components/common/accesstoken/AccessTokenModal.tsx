...
const AccessTokenModal: React.FC<AccessTokenModalProps> = ({
  ...
  const handleDownloadToken = () => {
    const tokenData = {
      ...
      instructions:
        "Use this access token to configure the client device for secure communication with the management server.",
    };
  ...
  return (
    <div
      className="config1-servermgmt-accesstoken-overlay"
      onClick={handleBackdropClick}
    >
      <div
        className="config1-servermgmt-accesstoken-modal"
        ...
        <div className="config1-servermgmt-accesstoken-content">
          <div className="config1-servermgmt-accesstoken-device-info">
            ...
            <div className="config1-servermgmt-accesstoken-device-details">
              <div className="config1-servermgmt-accesstoken-detail-item">
                <span className="config1-servermgmt-accesstoken-detail-label">
                  Device Name:
                </span>
                <span className="config1-servermgmt-accesstoken-detail-value">
                  {deviceInfo.tag}
                </span>
              </div>
              <div className="config1-servermgmt-accesstoken-detail-item">
          ...
          <div className="config1-servermgmt-accesstoken-section">
            ...
            <p className="config1-servermgmt-accesstoken-description">
              This access token is required for the client device to communicate
              securely with the management server. Please copy or download this
              token and configure it on the target device.
            </p>
          ...
          <div className="config1-servermgmt-accesstoken-warning">
            <div className="config1-servermgmt-accesstoken-warning-icon">
              ⚠️
            </div>
            <div className="config1-servermgmt-accesstoken-warning-text">
              <strong>Important:</strong> This token will only be displayed
              once. Make sure to copy or download it before closing this window.
              Keep this token secure and do not share it with unauthorized
              personnel.
            </div>
          </div>
        </div>
