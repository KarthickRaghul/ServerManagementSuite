...
const ServerConfiguration: React.FC = () => {
  ...
  // ✅ Enhanced handleApply with better error handling
    ...
    try {
      ...
      if (success) {
        addNotification({
          ...
          message:
            "Server hostname and timezone have been successfully updated. A restart may be required for hostname changes to take effect.",
          type: "success",
          duration: 6000,
        });
        setSubmitError(null);
  ...
  return (
    <>
      <div
        className="config1-serverconfig-card-container"
      ...
      >
        ...
        {loading && (
          <div className="config1-serverconfig-loading">Loading...</div>
        )}
        {error && (
          <div className="config1-serverconfig-error">Error loading config</div>
        )}
      </div>
            ...
            <form className="config1-serverconfig-form" onSubmit={handleApply}>
              <div className="config1-serverconfig-input-group">
                ...
                <div className="config1-serverconfig-help">
                  ...
                  <small>
                    Maximum 15 characters. Only letters, numbers, and hyphens
                    allowed.
                  </small>
                </div>
              </div>
              ...
              <div className="config1-serverconfig-input-group">
                ...
                <select
                  ...
                  disabled={updating}
                >
                  {/* ✅ Keep all your existing timezone options */}
