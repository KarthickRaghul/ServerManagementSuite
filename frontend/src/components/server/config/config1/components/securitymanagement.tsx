...
const SecurityManagement = () => {
    ...
    try {
      ...
      if (success) {
        addNotification({
          ...
          message:
            "SSH public key has been successfully uploaded and configured",
          type: "success",
          duration: 4000,
        });
        setSshKey("");
  ...
  return (
    <>
      <div
        className="config1-security-card-container"
      ...
      {isModalOpen && (
        <ModalWrapper title="Security Management" onClose={handleClose}>
...
ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAAB... user@hostname"
            ...
            <div className="config1-security-section">
              ...
              <form
                className="config1-security-form"
