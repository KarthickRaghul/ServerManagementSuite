...
import { NetworkOperationProvider } from "./context/NetworkOperationContext";
        ...
        <ConnectionOverlayProvider>
          <NetworkOperationProvider>
            <Router>
              ...
              <ConnectionOverlay />
              {/* Network operation overlay - renders on top of everything */}
              <NetworkOperationOverlay />
            </Router>
          </NetworkOperationProvider>
        </ConnectionOverlayProvider>
      </AppProvider>
